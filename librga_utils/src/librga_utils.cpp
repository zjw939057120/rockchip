...
int read_image_from_fbc_file(void *buf, const char *filePath, int sw, int sh, int fmt, int index) {
    int size;
...
int read_image_from_file(void *buf, const char *filePath, int sw, int sh, int fmt, int index) {
    int size;
...
int read_image_from_buf(void *buf, const void *src_buf, int length) {
    memcpy(buf, src_buf, length);

    return 0;
}

int write_image_to_fbc_file(void *buf, const char *filePath, int sw, int sh, int fmt, int index) {
    int size;
...
int write_image_to_file(void *buf, const char *filePath, int sw, int sh, int fmt, int index) {
    int size;
...
int write_image_to_buf(void *buf, const char *filePath, int sw, int sh, int fmt, int index) {
    int size;
